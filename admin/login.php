...
if (isset($_POST["login"])){
    ...
    if($valid){
        ...
        {
                $_SESSION['admin_id'] = $result['idadmin'];
...
<body style="background-color:#204a66;">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <img src="../images/oopsie movie hitam.png" style="width:250px;"><br><br>
                    <h1 class="h4 text-gray-900 mb-4" style="font-weight:bold;">Selamat Datang Admin !</h1><hr style="border-top: 2px solid black;">
                  </div>
