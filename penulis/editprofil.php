			...
			<h1 class="sidebar-heading">Hi! <?php echo ($_SESSION['nama']) ?></h1>
				...
				<div class="row">
					...
					<div class="col-sm-10">
						...
						$sql ="SELECT * FROM penulis WHERE email = '".$email."' ";
								...
								<tbody>
									...
									while ($result = mysqli_fetch_assoc($exec)){
										...
										<tr>
											...
											<td><a href="editprofilpenulis.php?idpenulis=<?php echo $author;?>"><button class="btn btn-warning">Edit Profile</i></button></a>  |  <a href="editpasswordpenulis.php?idpenulis=<?php echo $author;?>"><button class="btn btn-danger">Change Password</button></a></td>
										</tr>
										<?php $postNo++; 
									} ?>
